...
const styleSpan = isActive ? {color: "red"} : {color : "#fff"};
const styleSvg = isActive ? {stroke: "red"} : {stroke : "#fff"};
const styleSvgg = isActive ? {stroke: "red"} : {stroke : "#fff"};



    return (

        <div className='icon_bas'>

            <div>
                    <svg className={isActive ? 'svgActive' : ''}  width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div onClick={handleClick}>
                    <svg style={styleSvg} width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                         ...
                         <path d=" M462.3 62.6C407.5 15.9 326 24.3 275.7 76.2L256 96.5l-19.7-20.3C186.1 24.3 104.5 15.9 49.7 62.6c-62.8 53.6-66.1 149.8-9.9 207.9l193.5 199.8c12.5 12.9 32.8 12.9 45.3 0l193.5-199.8c56-58.1 53-154.3-9.8-207.9Z" fill="#D9D9D9">
                     ...
                     <span style={styleSpan} >{like}</span>
            </div> 
